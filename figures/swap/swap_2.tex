...
\begin{document}
    \begin{tikzpicture}
        ...
        \draw[ fill=blue] (2,1) rectangle (2+\sqd,1+\sqd);
        \draw[ fill=blue] (3,1) rectangle (3+\sqd,1+\sqd);
        \draw[ fill=blue] (4,1) rectangle (4+\sqd,1+\sqd);
        
        \draw[ fill=blue] (0,2) rectangle (0+\sqd,2+\sqd);
        \draw[ fill=red ] (1,2) rectangle (1+\sqd,2+\sqd);
        \draw[ fill=red] (2,2) rectangle (2+\sqd,2+\sqd);
        \draw[ fill=red] (3,2) rectangle (3+\sqd,2+\sqd);
        \draw[ fill=red] (4,2) rectangle (4+\sqd,2+\sqd);
